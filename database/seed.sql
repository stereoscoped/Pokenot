...
(1, 'Bulbasaur',  45,  49,  49,  45, 'images/bulbasaur.png'),
(2, 'Ivysaur',    60,  62,  63,  60, 'images/ivysaur.png'),
(3, 'Venusaur',   80,  82,  83,  80, 'images/venusaur.png'),
(4, 'Charmander', 39,  52,  43,  65, 'images/charmander.png'),
(5, 'Charmeleon', 58,  64,  58,  80, 'images/charmeleon.png'),
(6, 'Charizard',  78,  84,  78, 100, 'images/charizard.png'),
(7, 'Squirtle',   44,  48,  65,  43, 'images/squirtle.png'),
(8, 'Wartortle',  59,  63,  80,  58, 'images/wartortle.png'),
(9, 'Blastoise',  79,  83, 100,  78, 'images/blastoise.png'),
(10, 'Caterpie',   45, 30, 35, 45, 'images/caterpie.png'),
(11, 'Metapod',    50, 20, 55, 30, 'images/metapod.png'),
(12, 'Butterfree', 60, 45, 50, 70, 'images/butterfree.png'),
(13, 'Weedle',     40, 35, 30, 50, 'images/weedle.png'),
(14, 'Kakuna',     45, 25, 50, 35, 'images/kakuna.png'),
(15, 'Beedrill',   65, 90, 40, 75, 'images/beedrill.png'),
(16, 'Pidgey',     40, 45, 40, 56, 'images/pidgey.png'),
(17, 'Pidgeotto',  63, 60, 55, 71, 'images/pidgeotto.png'),
(18, 'Pidgeot',    83, 80, 75, 101, 'images/pidgeot.png'),
(19, 'Rattata',    30, 56, 35, 72, 'images/rattata.png'),
(20, 'Raticate',   55, 81, 60, 97, 'images/raticate.png'),
(21, 'Spearow',    40, 60, 30, 70, 'images/spearow.png'),
(22, 'Fearow',     65, 90, 65, 100, 'images/fearow.png'),
(23, 'Ekans',      35, 60, 44, 55, 'images/ekans.png'),
(24, 'Arbok',      60, 95, 69, 80, 'images/arbok.png'),
(25, 'Pikachu',    35, 55, 40, 90, 'images/pikachu.png'),
(26, 'Raichu',     60, 90, 55, 110, 'images/raichu.png'),
(27, 'Sandshrew',  50, 75, 85, 40, 'images/sandshrew.png'),
(28, 'Sandslash',  75, 100, 110, 65, 'images/sandslash.png'),
(29, 'Nidoran♀',   55, 47,  52,  41, 'images/nidoran_f.png'),
(30, 'Nidorina',   70, 62,  67,  56, 'images/nidorina.png'),
(31, 'Nidoqueen',  90, 92,  87,  76, 'images/nidoqueen.png'),
(32, 'Nidoran♂',   46, 57,  40,  50, 'images/nidoran_m.png'),
(33, 'Nidorino',   61, 72,  57,  65, 'images/nidorino.png'),
(34, 'Nidoking',   81, 102, 77,  85, 'images/nidoking.png'),
(35, 'Clefairy',   70, 45,  48,  35, 'images/clefairy.png'),
(36, 'Clefable',   95, 70,  73,  60, 'images/clefable.png'),
(37, 'Vulpix',     38, 41, 40, 65, 'images/vulpix.png'),
(38, 'Ninetales',  73, 76, 75, 100, 'images/ninetales.png'),
(39, 'Jigglypuff', 115, 45, 20, 20, 'images/jigglypuff.png'),
(40, 'Wigglytuff', 140, 70, 45, 45, 'images/wigglytuff.png'),
(41, 'Zubat',      40, 45, 35, 55, 'images/zubat.png'),
(42, 'Golbat',     75, 80, 70, 90, 'images/golbat.png'),
(43, 'Oddish',     45, 50, 55, 30, 'images/oddish.png'),
(44, 'Gloom',      60, 65, 70, 40, 'images/gloom.png'),
(45, 'Vileplume',  75, 80, 85, 50, 'images/vileplume.png'),
(46, 'Paras',      35, 70, 55, 25, 'images/paras.png'),
(47, 'Parasect',   60, 95, 80, 30, 'images/parasect.png'),
(48, 'Venonat',    60, 55, 50, 45, 'images/venonat.png'),
(49, 'Venomoth',   70, 65, 60, 90, 'images/venomoth.png'),
(50, 'Diglett',    10, 55, 25, 95, 'images/diglett.png'),
(51, 'Dugtrio',    35, 100, 50, 120, 'images/dugtrio.png'),
(52, 'Meowth',     40, 45, 35, 90, 'images/meowth.png'),
(53, 'Persian',    65, 70, 60, 115, 'images/persian.png'),
(54, 'Psyduck',    50, 52, 48, 55, 'images/psyduck.png'),
(55, 'Golduck',    80, 82, 78, 85, 'images/golduck.png'),
(56, 'Mankey',     40, 80, 35, 70, 'images/mankey.png'),
(57, 'Primeape',   65, 105, 60, 95, 'images/primeape.png'),
(58, 'Growlithe',  55, 70, 45, 60, 'images/growlithe.png'),
(59, 'Arcanine',   90, 110, 80, 95, 'images/arcanine.png'),
(60, 'Poliwag',    40, 50, 40, 90, 'images/poliwag.png'),
(61, 'Poliwhirl',  65, 65, 65, 90, 'images/poliwhirl.png'),
(62, 'Poliwrath',  90, 95, 95, 70, 'images/poliwrath.png'),
(63, 'Abra',       25, 20, 15, 90, 'images/abra.png'),
(64, 'Kadabra',    40, 35, 30, 105, 'images/kadabra.png'),
(65, 'Alakazam',   55, 50, 45, 120, 'images/alakazam.png'),
(66, 'Machop',     70, 80, 50, 35,  'images/machop.png'),
(67, 'Machoke',    80, 100, 70, 45, 'images/machoke.png'),
(68, 'Machamp',    90, 130, 80, 55, 'images/machamp.png'),
(69, 'Bellsprout', 50, 75, 35, 40,  'images/bellsprout.png'),
(70, 'Weepinbell', 65, 90, 50, 55,  'images/weepinbell.png'),
(71, 'Victreebel', 80, 105, 65, 70, 'images/victreebel.png'),
(72, 'Tentacool',  40, 40, 35, 70,  'images/tentacool.png'),
(73, 'Tentacruel', 80, 70, 65, 100, 'images/tentacruel.png'),
(74, 'Geodude',    40, 80, 100, 20, 'images/geodude.png'),
(75, 'Graveler',   55, 95, 115, 35, 'images/graveler.png'),
(76, 'Golem',      80, 120, 130, 45, 'images/golem.png'),
(77, 'Ponyta',     50, 85, 55, 90, 'images/ponyta.png'),
(78, 'Rapidash',   65, 100, 70, 105, 'images/rapidash.png'),
(79, 'Slowpoke',   90, 65, 65, 15, 'images/slowpoke.png'),
(80, 'Slowbro',    95, 75, 110, 30, 'images/slowbro.png'),
(81, 'Magnemite',  25, 35, 70, 45, 'images/magnemite.png'),
(82, 'Magneton',   50, 60, 95, 70, 'images/magneton.png'),
(83, 'Farfetch''d', 52, 90, 55, 60, 'images/farfetchd.png'),
(84, 'Doduo',      35, 85, 45, 75, 'images/doduo.png'),
(85, 'Dodrio',     60, 110, 70, 110, 'images/dodrio.png'),
(86, 'Seel',       65, 45, 55, 45, 'images/seel.png'),
(87, 'Dewgong',    90, 70, 80, 70, 'images/dewgong.png'),
(88, 'Grimer',     80, 80, 50, 25, 'images/grimer.png'),
(89, 'Muk',        105, 105, 75, 50, 'images/muk.png'),
(90, 'Shellder',   30, 65, 100, 40, 'images/shellder.png'),
(91, 'Cloyster',   50, 95, 180, 70, 'images/cloyster.png'),
(92, 'Gastly',     30, 35, 30, 80, 'images/gastly.png'),
(93, 'Haunter',    45, 50, 45, 95, 'images/haunter.png'),
(94, 'Gengar',     60, 65, 60, 110, 'images/gengar.png'),
(95, 'Onix',       35, 45, 160, 70, 'images/onix.png'),
(96, 'Drowzee',    60, 48, 45, 42, 'images/drowzee.png'),
(97, 'Hypno',      85, 73, 70, 67, 'images/hypno.png'),
(98, 'Krabby',     30, 105, 90, 50, 'images/krabby.png'),
(99, 'Kingler',    55, 130, 115, 75,'images/kingler.png'),
(100, 'Voltorb',    40, 30, 50, 100, 'images/voltorb.png'),
(101, 'Electrode',  60, 50, 70, 150, 'images/electrode.png'),
(102, 'Exeggcute',  60, 40, 80, 40,  'images/exeggcute.png'),
(103, 'Exeggutor',  95, 95, 85, 55,  'images/exeggutor.png'),
(104, 'Cubone',     50, 50, 95, 35,  'images/cubone.png'),
(105, 'Marowak',    60, 80, 110, 45, 'images/marowak.png'),
(106, 'Hitmonlee',  50, 120, 53, 87, 'images/hitmonlee.png'),
(107, 'Hitmonchan', 50, 105, 79, 76, 'images/hitmonchan.png'),
(108, 'Lickitung',  90, 55, 75, 30,  'images/lickitung.png'),
(109, 'Koffing',    40, 65,  95,  35, 'images/koffing.png'),
(110, 'Weezing',    65, 90,  120, 60, 'images/weezing.png'),
(111, 'Rhyhorn',    80, 85,  95,  25, 'images/rhyhorn.png'),
(112, 'Rhydon',     105,130, 120, 40, 'images/rhydon.png'),
(113, 'Chansey',    250,5,   5,   50, 'images/chansey.png'),
(114, 'Tangela',    65, 55,  115, 60, 'images/tangela.png'),
(115, 'Kangaskhan', 105,95,  80,  90, 'images/kangaskhan.png'),
(116, 'Horsea',     30, 40,  70,  60, 'images/horsea.png'),
(117, 'Seadra',     55, 65,  95,  85, 'images/seadra.png'),
(118, 'Goldeen',    45, 67,  60,  63, 'images/goldeen.png'),
(119, 'Seaking',    80, 92,  65,  68, 'images/seaking.png'),
(120, 'Staryu',     30, 45,  55,  85, 'images/staryu.png'),
(121, 'Starmie',    60, 75,  85,  115, 'images/starmie.png'),
(122, 'Mr. Mime',   40, 45,  65,  90, 'images/mr_mime.png'),
(123, 'Scyther',    70, 110, 80,  105, 'images/scyther.png'),
(124, 'Jynx',       65, 50,  35,  95, 'images/jynx.png'),
(125, 'Electabuzz', 65, 83,  57,  105, 'images/electabuzz.png'),
(126, 'Magmar',     65, 95,  57,  93, 'images/magmar.png'),
(127, 'Pinsir',     65, 125, 100, 85, 'images/pinsir.png'),
(128, 'Tauros',     75, 100, 95,  110, 'images/tauros.png'),
(129, 'Magikarp',   20, 10,  55,  80, 'images/magikarp.png'),
(130, 'Gyarados',   95, 125, 79,  81, 'images/gyarados.png'),
(131, 'Lapras',     130,85,  80,  60, 'images/lapras.png'),
(132, 'Ditto',      48, 48,  48,  48, 'images/ditto.png'),
(133, 'Eevee',      55, 55,  50,  55, 'images/eevee.png'),
(134, 'Vaporeon',   130,65,  60,  65, 'images/vaporeon.png'),
(135, 'Jolteon',    65, 65,  60,  130, 'images/jolteon.png'),
(136, 'Flareon',    65, 130, 60,  65,  'images/flareon.png'),
(137, 'Porygon',    65, 60,  70,  40,  'images/porygon.png'),
(138, 'Omanyte',    35, 40,  100, 35,  'images/omanyte.png'),
(139, 'Omastar',    70, 60,  125, 55,  'images/omastar.png'),
(140, 'Kabuto',     30, 80,  90,  55,  'images/kabuto.png'),
(141, 'Kabutops',   60, 115, 105, 80,  'images/kabutops.png'),
(142, 'Aerodactyl', 80, 105, 65,  130, 'images/aerodactyl.png'),
(143, 'Snorlax',    160,110, 65,  30,  'images/snorlax.png'),
(144, 'Articuno',   90, 85,  100, 85,  'images/articuno.png'),
(145, 'Zapdos',     90, 90,  85,  100, 'images/zapdos.png'),
(146, 'Moltres',    90, 100, 90,  90,  'images/moltres.png'),
(147, 'Dratini',    41, 64,  45,  50,  'images/dratini.png'),
(148, 'Dragonair',  61, 84,  65,  70,  'images/dragonair.png'),
(149, 'Dragonite',  91, 134, 95,  80,  'images/dragonite.png'),
(150, 'Mewtwo',     106,110, 90,  130, 'images/mewtwo.png'),
(151, 'Mew',        100,100, 100, 100, 'images/mew.png');
...
-- Link everything together with IDs
